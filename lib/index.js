...
Uber.prototype = {
   ...
   *
   */
  getPromotions: function(start_latitude, start_longitude, end_latitude, end_longitude, callback) {
    callback = (typeof callback === 'undefined') ? function(e,b){} : callback;
    var u = url+this.version+"/promotions?start_latitude="+start_latitude+"&start_longitude="+start_longitude;
    u += "&end_latitude="+end_latitude+"&end_longitude="+end_longitude;
    get(this.getAuthToken(), u, callback);
  },
