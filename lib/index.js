...
function Uber(data) {
  ...
  function getProducts(params, callback) {
    ...
    return helper.get(this.getAuthToken(), baseUrl + endpoint.product_types 
      + "?latitude="+ params.lat + "&longitude=" + params.lng, callback);
  }
  ...
  function getPriceEstimate(params, callback) {
    ...
    var u = baseUrl + endpoint.price_estimates + "?";
    u += "start_latitude=" + params.sLat + "&start_longitude=" + params.sLng;
